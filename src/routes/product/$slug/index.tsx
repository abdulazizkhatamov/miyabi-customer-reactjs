...
function RouteComponent() {
  ...
  return (
    ...
    >
      ...
      {/* Right: Product Info */}
      <div css={css({ display: 'flex', flexDirection: 'column', gap: '16px' })}>
        <h1 css={css({ fontSize: '24px', fontWeight: 600 })}>{product.name}</h1>
        ...
        <div css={css({ fontSize: '20px', fontWeight: 700, color: '#d32f2f' })}>
